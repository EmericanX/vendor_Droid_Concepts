...
ALARM_PATH := vendor/Droid_Concepts/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/Droid_Concepts/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/Droid_Concepts/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/Droid_Concepts/prebuilt/common/media/audio/ui
