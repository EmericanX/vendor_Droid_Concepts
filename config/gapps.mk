...
# 
PRODUCT_COPY_FILES += \
    vendor/Droid_Concepts/prebuilt/droid_concepts/app/ChromeBookmarksSyncAdapter.apk:system/app/ChromeBookmarksSyncAdapter.apk \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/app/LatinImeDictionaryPack.apk:system/app/ \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/tts/lang_pico/de-DE_gl0_sg.bin:system/tts/lang_pico/de-DE_gl0_sg.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/tts/lang_pico/de-DE_ta.bin:system/tts/de-DE_ta.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/tts/lang_pico/es-ES_ta.bin:system/tts/es-ES_ta.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/tts/lang_pico/es-ES_zl0_sg.bin:system/tts/es-ES_zl0_sg.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/tts/lang_pico/fr-FR_nk0_sg.bin:system/tts/fr-FR_nk0_sg.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/tts/lang_pico/fr-FR_ta.bin:system/tts/fr-FR_ta.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/tts/lang_pico/it-IT_cm0_sg.bin:system/tts/it-IT_cm0_sg.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/tts/lang_pico/it-IT_ta.bin:system/tts/it-IT_ta.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/acoustic_model:system/usr/srec/acoustic_model \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/c_fst:system/usr/srec/en-US/c_fst \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/clg:system/usr/srec/en-US/clg \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/compile_grammar.config:system/usr/srec/en-US/compile_grammar.config \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/contacts.abnf:system/usr/srec/en-US/contacts.abnf \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/dict:system/usr/srec/en-US/dict \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/dictation.config:system/usr/srec/en-US/dictation.config \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/embed_phone_nn_model:system/usr/srec/en-US/embed_phone_nn_model \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/embed_phone_nn_state_sym:system/usr/srec/en-US/embed_phone_nn_state_sym \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/endpointer_dictation.config:system/usr/srec/en-US/endpointer_dictation.config \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/endpointer_voicesearch.config:system/usr/srec/en-US/endpointer_voicesearch.config \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/ep_acoustic_model:system/usr/srec/en-US/ep_acoustic_model \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/g2p_fst:system/usr/srec/en-US/g2p_fst \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/google_hotword.config:system/usr/srec/en-US/google_hotword.config \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/google_hotword_clg:system/usr/srec/en-US/google_hotword_clg \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/google_hotword_logistic:system/usr/srec/en-US/google_hotword_logistic \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/grammar.config:system/usr/srec/en-US/grammar.config \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/hmmsyms:system/usr/srec/en-US/hmmsyms \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/hotword_symbols:system/usr/srec/en-US/hotword_symbols \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/offensive_word_normalizer:system/usr/srec/en-US/offensive_word_normalizer \
...
PRODUCT_COPY_FILES += \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/left_eye-y0-yi45-p0-pi45-r0-ri20.lg_32/full_model.bin:system/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/left_eye-y0-yi45-p0-pi45-r0-ri20.lg_32/full_model.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/nose_base-y0-yi45-p0-pi45-r0-ri20.lg_32/full_model.bin:system/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/nose_base-y0-yi45-p0-pi45-r0-ri20.lg_32/full_model.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/right_eye-y0-yi45-p0-pi45-r0-ri20.lg_32-2/full_model.bin:system/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/right_eye-y0-yi45-p0-pi45-r0-ri20.lg_32-2/full_model.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-r0-ri30.4a-v24/full_model.bin:system/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-r0-ri30.4a-v24/full_model.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rn30-ri30.5-v24/full_model.bin:system/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rn30-ri30.5-v24/full_model.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rp30-ri30.5-v24/full_model.bin:system/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rp30-ri30.5-v24/full_model.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/vendor/pittpatt/models/recognition/face.face.y0-y0-22-b-N/full_model.bin:system/vendor/pittpatt/models/recognition/face.face.y0-y0-22-b-N/full_model.bin
