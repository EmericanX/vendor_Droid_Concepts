...
PRODUCT_COPY_FILES += \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/app/Currents.apk:system/app/Currents.apk \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/libearthandroid.so:system/lib/libearthandroid.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/libearthmobile.so:system/lib/libearthmobile.so \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/librs.antblur_drama.so:system/lib/librs.antblur_drama.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/librs.film_base.so:system/lib/librs.film_base.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/librs.fixedframe.so:system/lib/librs.fixedframe.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/librs.grey.so:system/lib/librs.grey.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/librs.image_wrapper.so:system/lib/librs.image_wrapper.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/librs.retrolux.so:system/lib/librs.retrolux.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/librsjni.so:system/lib/librsjni.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/libRSSupport.so:system/lib/libRSSupport.so \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/libwebp_android.so:system/lib/libwebp_android.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/lib/libWVphoneAPI.so:system/lib/libWVphoneAPI.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/c_fst:system/usr/srec/en-US/c_fst \
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/classifier:system/usr/srec/en-US/classifier \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/dnn:system/usr/srec/en-US/dnn \
    ...
    vendor/Droid_Concepts/prebuilt/droid_concepts/usr/srec/en-US/hmmlist:system/usr/srec/en-US/hmmlist \
...
#
PRODUCT_COPY_FILES += \
    vendor/Droid_Concepts/prebuilt/droid_concepts/face/app/FaceLock.apk:system/app/FaceLock.apk \
    vendor/Droid_Concepts/prebuilt/droid_concepts/face/lib/libfacelock_jni.so:system/lib/libfacelock_jni.so \
    vendor/Droid_Concepts/prebuilt/droid_concepts/face/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/left_eye-y0-yi45-p0-pi45-r0-ri20.lg_32.bin:system/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/left_eye-y0-yi45-p0-pi45-r0-ri20.lg_32.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/face/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/nose_base-y0-yi45-p0-pi45-r0-ri20.lg_32.bin:system/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/nose_base-y0-yi45-p0-pi45-r0-ri20.lg_32.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/face/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/right_eye-y0-yi45-p0-pi45-r0-ri20.lg_32-2.bin:system/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/right_eye-y0-yi45-p0-pi45-r0-ri20.lg_32-2.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/face/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-r0-ri30.4a-v24.bin:system/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-r0-ri30.4a-v24.bin \
    vendor/Droid_Concepts/prebuilt/droid_concepts/face/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rn30-ri30.5-v24.bin:system/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rn30-ri30.5-v24.bin \
